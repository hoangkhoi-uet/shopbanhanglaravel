...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home($category_id) {
        ...
        $category_n = DB::table('tbl_category_product')->where('tbl_category_product.category_id', $category_id)->limit(1)->get();

        return view('pages.category.show_category')->with('category', $cate_product)->with('brand', $brand_product)->with('category_by_id', $category_by_id)->with('category_n', $category_n);
    }
